...
var elizaInitials = [
"How do you do.  Let me know how I can help you.",
// additions (not original)
"Please tell me what's I can help you with.",
"Is something needed to be done for you ?"
];

var elizaFinals = [
"Goodbye.  I hope I could help.",
// additions (not original)
"Goodbye.  This was really a nice conversation.",
"Goodbye.  I'm looking forward to helping you next time.",
"This was a productive time, wasn't it -- but time is over now.   Goodbye.",
"Maybe we could discuss this moreover next time ?   Goodbye."
];
...
["name", 15, [
 ["*", [
     "That's a nice name.",
     "I've told you before, you have a nice name -- please continue."
  ]]
]],
["deutsch", 0, [
 ["*", [
...
function ElizaBot(noRandomFlag, globalObj) {
	this.noRandom= (noRandomFlag)? true:false;
	this.capitalizeFirstLetter=true;
	this.debug=false;
	this.memSize=20;
	this.version="1.1 (original)";
	if (!this._dataParsed) this._init(globalObj);
	this.reset();
}
...
ElizaBot.prototype._init = function(globalObj) {
	// install ref to global object
	var global=ElizaBot.prototype.global=globalObj;
